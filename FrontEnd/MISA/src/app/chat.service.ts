...
export class ChatService{
  ...
  async createConversation() {
    try {
      ...
      console.error("Error creating new conversation")
      this.snackBar.open("Error creating new conversation", '' ,{duration: 2500})
      return
    }
  }
  ...
  async getAllConversations() {
    try {
      ...
      console.error("Error fetching all conversations")
      this.snackBar.open("Error fetching all conversations", '' ,{duration: 2500})
      return
    }
  }
  ...
  async getConversation() {
    try {
      ...
      console.error("Error fetching conversation")
      this.snackBar.open("Error fetching conversation", '' ,{duration: 2500})
      return
    }
  }
  ...
  async getResponse(message:string) {
    if (!this.conversation_id.getValue()){
  ...
  async updateConversationTitle(title: string) {
    try {
      ...
      this.snackBar.open("Error updating conversation title", '' ,{duration: 2500})
      return
    }
  }
